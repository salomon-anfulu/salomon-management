...
const Store = {
  ...
  defaults: {
    ...
    // 换班统计（缺卡/迟到/旷工已改为从灵工打卡动态计算，门迎/点评已移至各自模块）
      ...
      '田佳乐': { doorCount: 20, shiftChange: 1, shiftedCount: 0 },
      '迟骋': { doorCount: 13, shiftChange: 1, shiftedCount: 0 },
      '王靳毓': { doorCount: 16, shiftChange: 1, shiftedCount: 2 },
      '朱凯赟': { doorCount: 15, shiftChange: 0, shiftedCount: 0 },
      '孔祥宇': { doorCount: 11, shiftChange: 1, shiftedCount: 0 },
      '邓奇缘': { doorCount: 15, shiftChange: 0, shiftedCount: 1 },
      '杨子豪': { doorCount: 10, shiftChange: 2, shiftedCount: 0 },
      '王雅澜': { doorCount: 15, shiftChange: 1, shiftedCount: 2 },
      ...
      '龚赟昊': { doorCount: 10, shiftChange: 0, shiftedCount: 1 }
    },
...
ratings: [
    ...
    },
    {
      ...
      "hourlyRate": 60
        ...
        linggongAttendance: {
      lastSync: '2026-06-25T03:06:36.000Z',
      records: [
        ...
        { "name": "龚赟昊", "date": "2026-06-25", "signIn": "-", "signOut": "-", "status": "未开始考勤", "totalHours": "0" },
        { "name": "孔祥宇", "date": "2026-06-25", "signIn": "-", "signOut": "-", "status": "未开始考勤", "totalHours": "0" },
        { "name": "李若彤", "date": "2026-06-25", "signIn": "-", "signOut": "-", "status": "未开始考勤", "totalHours": "0" },
        { "name": "玛依拉·努尔夏提", "date": "2026-06-25", "signIn": "-", "signOut": "-", "status": "未开始考勤", "totalHours": "0" },
        { "name": "田佳乐", "date": "2026-06-25", "signIn": "-", "signOut": "-", "status": "未开始考勤", "totalHours": "0" },
        { "name": "王靳毓", "date": "2026-06-25", "signIn": "10:16", "signOut": "-", "status": "考勤中", "totalHours": "0" },
        { "name": "王雅澜", "date": "2026-06-25", "signIn": "09:44", "signOut": "-", "status": "考勤中", "totalHours": "0" },
        { "name": "杨子豪", "date": "2026-06-25", "signIn": "-", "signOut": "-", "status": "未开始考勤", "totalHours": "0" },
        { "name": "祖白代·阿不利孜", "date": "2026-06-25", "signIn": "10:11", "signOut": "-", "status": "考勤中", "totalHours": "0" },
      ]
    },
...
june: {
  ...
  init() {
    if (!localStorage.getItem(this.KEY)) {
      ...
      const DATA_VERSION = '2026-06-25-v1';
