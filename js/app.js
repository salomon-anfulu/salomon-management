...
const Store = {
  ...
  defaults: {
    staff: [
      ...
      // 王龙宇 已离职（v205: 彻底移除模式——全月隐藏+业绩/评分/好评/门迎/店务/灵工等所有相关数据删除; 人员管理保留"离职"状态）
      ...
      // v211: 新入职4名仓库兼职（9/17-9/18，刘晓静/和卫鹏/李淑婷9/17起已有灵工打卡，王佳鸣待上岗）
...
linggongAttendance: {
      ...
      },
      {
            ...
            august: {
              ...
              avgPrice: 1107,
              avgHourlyOutput: 0,
              note: '8月业绩(8/1-8/31 小票导出53全量+56筛选导出合并去重1121行)-全店结算净额67532(含退货冲减); workHours/hourlyOutput置0待运行时动态补; 归因v5: 备注列19+ASCII边界匹配+大小写不敏感+HQ券码/抵用券/YCZF/XS噪声剔除+HQY=何秋烨铁律+退货按备注内原小票号回溯+整单退净不计tickets; 8/30-8/31新增: 龚赟昊+5700(8/30四笔含0元广宣品+8/31两笔含抵用券变体GYH[抵用券KMZD8QVALQ])/王雅澜+1398(8/30 WYL)/杨子豪+598(8/31 yzh外宾); 8/31外宾118无归因正确排除; 8/9-8/10无小票数据; 8/1-8/29子集59836与v187精确对账一致',
              records: [
                { name: '龚赟昊', sales: 12688, qty: 12, tickets: 7, upt: 1.71, avgPrice: 1057, workHours: 0, hourlyOutput: 0, salesShare: 0.1879, categories: '鞋履 77.1% / 服装 22.0% / 配件 0.9%' },
                { name: '梁实秋', sales: 9990, qty: 5, tickets: 3, upt: 1.67, avgPrice: 1998, workHours: 0, hourlyOutput: 0, salesShare: 0.1479, categories: '服装 73.0% / 鞋履 27.0%' },
                { name: '王龙宇', sales: 9242, qty: 9, tickets: 7, upt: 1.29, avgPrice: 1027, workHours: 0, hourlyOutput: 0, salesShare: 0.1369, categories: '鞋履 74.6% / 服装 15.1% / 配件 10.3%' },
                { name: '王雅澜', sales: 8690, qty: 6, tickets: 5, upt: 1.2, avgPrice: 1448, workHours: 0, hourlyOutput: 0, salesShare: 0.1287, categories: '鞋履 62.0% / 服装 38.0%' },
                { name: '孔祥宇', sales: 7266, qty: 7, tickets: 5, upt: 1.4, avgPrice: 1038, workHours: 0, hourlyOutput: 0, salesShare: 0.1076, categories: '鞋履 79.7% / 服装 20.3%' },
                { name: '何秋烨', sales: 5692, qty: 4, tickets: 4, upt: 1.0, avgPrice: 1423, workHours: 0, hourlyOutput: 0, salesShare: 0.0843, categories: '鞋履 100.0%' },
                { name: '迟骋', sales: 4486, qty: 7, tickets: 4, upt: 1.75, avgPrice: 641, workHours: 0, hourlyOutput: 0, salesShare: 0.0664, categories: '鞋履 53.4% / 服装 42.2% / 配件 4.4%' },
                { name: '唐蓉', sales: 3992, qty: 4, tickets: 4, upt: 1.0, avgPrice: 998, workHours: 0, hourlyOutput: 0, salesShare: 0.0591, categories: '鞋履 100.0%' },
                { name: '贾长乐', sales: 3394, qty: 3, tickets: 3, upt: 1.0, avgPrice: 1131, workHours: 0, hourlyOutput: 0, salesShare: 0.0503, categories: '鞋履 100.0%' },
                { name: '邓奇缘', sales: 998, qty: 1, tickets: 1, upt: 1.0, avgPrice: 998, workHours: 0, hourlyOutput: 0, salesShare: 0.0148, categories: '鞋履 100.0%' },
                { name: '杨子豪', sales: 696, qty: 2, tickets: 2, upt: 1.0, avgPrice: 348, workHours: 0, hourlyOutput: 0, salesShare: 0.0103, categories: '服装 85.9% / 配件 14.1%' },
            ...
            september: {
              ...
              avgPrice: 1204,
              avgHourlyOutput: 0,
              note: '9月业绩(9/1-9/8, 小票63全量9/1-9/6+小票69筛选导出新增9/7-9/8合并去重474行)-兼职净额110741/92件/63票/12人; v188铁律: 筛选导出不能单用须与全量合并(重叠子集9/1-9/6共109行已验证为小票63子集且备注0差异); 新增12行: 玛依拉5510(MYL 5笔含MYL WB变体)/贾长乐4199(JCL 3笔)/孔祥宇2601(KXY 2笔+HQ券码正确剥离)/杨子豪1398(yzh外宾); 手工归因2笔(店长确认): 孔祥宇4494(票09060028 9/6)+玛依拉1398(票09070012 9/7 XT-EVO原无备注); 月内退货冲减唐蓉-2504/梁实秋-1398/杨子豪-5094; 跨月退货-8188排除; workHours/hourlyOutput置0待运行时动态补',
              records: [
                { name: '梁实秋', sales: 21828, qty: 16, tickets: 7, upt: 2.29, avgPrice: 1364, workHours: 0, hourlyOutput: 0, salesShare: 0.1971, categories: '鞋履 62.7% / 服装 36.2% / 配件 1.2%' },
                { name: '杨子豪', sales: 12898, qty: 11, tickets: 7, upt: 1.57, avgPrice: 1173, workHours: 0, hourlyOutput: 0, salesShare: 0.1165, categories: '鞋履 82.1% / 服装 17.0% / 配件 0.9%' },
                { name: '玛依拉', sales: 12698, qty: 11, tickets: 10, upt: 1.1, avgPrice: 1154, workHours: 0, hourlyOutput: 0, salesShare: 0.1147, categories: '鞋履 95.1% / 服装 3.9% / 配件 0.9%' },
                { name: '贾长乐', sales: 11405, qty: 10, tickets: 8, upt: 1.25, avgPrice: 1141, workHours: 0, hourlyOutput: 0, salesShare: 0.1030, categories: '鞋履 72.7% / 服装 26.3% / 配件 1.0%' },
                { name: '唐蓉', sales: 10948, qty: 11, tickets: 7, upt: 1.57, avgPrice: 995, workHours: 0, hourlyOutput: 0, salesShare: 0.0989, categories: '鞋履 81.2% / 配件 14.2% / 服装 4.6%' },
                { name: '朱凯赟', sales: 8611, qty: 7, tickets: 6, upt: 1.17, avgPrice: 1230, workHours: 0, hourlyOutput: 0, salesShare: 0.0778, categories: '鞋履 61.5% / 服装 38.5%' },
                { name: '孔祥宇', sales: 8493, qty: 6, tickets: 3, upt: 2, avgPrice: 1416, workHours: 0, hourlyOutput: 0, salesShare: 0.0767, categories: '鞋履 87.0% / 服装 13.0%' },
                { name: '邓奇缘', sales: 7588, qty: 6, tickets: 5, upt: 1.2, avgPrice: 1265, workHours: 0, hourlyOutput: 0, salesShare: 0.0685, categories: '鞋履 90.8% / 服装 9.2%' },
                { name: '迟骋', sales: 7288, qty: 6, tickets: 4, upt: 1.5, avgPrice: 1215, workHours: 0, hourlyOutput: 0, salesShare: 0.0658, categories: '鞋履 71.2% / 服装 28.8%' },
                { name: '龚赟昊', sales: 4890, qty: 5, tickets: 4, upt: 1.25, avgPrice: 978, workHours: 0, hourlyOutput: 0, salesShare: 0.0442, categories: '鞋履 98.0% / 配件 2.0%' },
                { name: '王龙宇', sales: 2496, qty: 2, tickets: 1, upt: 2, avgPrice: 1248, workHours: 0, hourlyOutput: 0, salesShare: 0.0225, categories: '鞋履 100.0%' },
                { name: '何秋烨', sales: 1598, qty: 1, tickets: 1, upt: 1, avgPrice: 1598, workHours: 0, hourlyOutput: 0, salesShare: 0.0144, categories: '鞋履 100.0%' },
              ]
            },
    },
    ...
    customerReviews: [
      ...
      { id: 48, staffName: '邓奇缘', month: '2026-08', rating: 5, reviewDate: '2026-08-29', snippet: 'salomon 旁边开了个摄影展，还可以写明信片免费邮寄，特别好的体验。感谢天天小哥哥的耐心导览', keywords: ['摄影展', '明信片免费邮寄', '感谢天天', '耐心导览', '超预期'], source: '大众点评（Lucas，Lv2）' },
  ...
  init() {
    try {
      ...
      const DATA_VERSION = '2026-09-15-v211';
